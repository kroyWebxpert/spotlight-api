<?php
namespace Spotlight\Repository\Clients;
...
class CampaignRepository
{
    ...
    public function getCampaignMatchfieldById($campaign_id)
    {   
        $data = ['campaignId'=> $campaign_id];
        $result     =   $this->em->getRepository(CampaignMatchfields::class)->findBy($data);
        return $result;     
    }
